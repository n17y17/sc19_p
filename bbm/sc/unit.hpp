...
class _hz : _unit
{
    ...
    static constexpr double MaxHz = 1000000.0;  // 最大の周波数(Hz)
...
class _m : _unit
{
    ...
    static constexpr double Max_m = 50000000.0;  // 最大の周波数長さ(m)
...
class _km : _unit
{
    ...
    static constexpr double Max_km = 50000.0;  // 最大の周波数長さ(km)
