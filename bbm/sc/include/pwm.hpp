...
private:
    ...
    static inline const Freq MaxFreq = 125'000'000_hz;
    static inline const Freq MinFreq = 8.0_hz;
    static constexpr uint16_t MaxWrap = 0xffff;
    static constexpr uint16_t MinWrap = 1;
